...
export const mockNutrientDefinitions: NutrientDefinition[] = [
  ...
  { key: 'dietary_fiber', display_name: 'Dietary Fiber', unit: 'g', user_id: null },
  { key: 'sugars', display_name: 'Sugars', unit: 'g', user_id: null },
  { key: 'sodium', display_name: 'Sodium', unit: 'mg', user_id: null },
  { key: 'saturated_fat', display_name: 'Saturated Fat', unit: 'g', user_id: null },
];
...
export const mockRecipeNutrients: RecipeNutrient[] = [
  ...
  { recipe_id: 'rec-1', nutrient_key: 'dietary_fiber', unit: 'g', total_amount: 12 }, // 4×0.6 + 4×2.4
...
export const mockFoodLogNutrients: FoodLogNutrient[] = [
  ...
  { id: 'fln-9', food_log_id: 'fl-2', nutrient_key: 'dietary_fiber', amount: 3, unit: 'g' },
];
